...
<html lang="en">
	<head>
		...
		<meta property="description" content="<?php echo __SITE__['description']; ?>">
		<meta name="keywords" content="<?php echo __SITE__['keyword']; ?>">
		<meta name="author" content="Safflower">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta property="og:title" content="<?php echo $title; ?>">
		<meta property="og:site_name" content="<?php echo __SITE__['title']; ?>">
		...
		<meta property="og:description" content="<?php echo __SITE__['description']; ?>">
		<meta name="twitter:card" content="summary">
		<meta name="twitter:title" content="<?php echo $title; ?>">
		<meta name="twitter:site" content="<?php echo __SITE__['title']; ?>">
		...
		<meta name="twitter:description" content="<?php echo __SITE__['description']; ?>"/>
